...
Double_t GasLateralUncertainty = 0.; // 0mm for this moment: mm, lateral uncertainty of avalanche center
...
Double_t Zreadout = 2.0 + 2.0 + 2.0 + 180. * 1.e-3; // mm, readout plane distance from the Cu of first GEM foil
...
TH2D* stripMap = new TH2D("strip map DID=0", "strip map DID=0",
                       ...
                       map_y_bins, map_y_low, map_y_high); // in mm, width 400um=0.4mm
    //signal
