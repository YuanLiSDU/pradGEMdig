...
GEMDetectorLayer::GEMDetectorLayer() : id(-1), nChambersPerLayer(2), readout_type("CARTESIAN"),
    x_offset(0), y_offset(0),
    gem_type("PRADSIMGEM"), nb_apvs_chamber_x_plane(13),
    nb_apvs_chamber_y_plane(24), x_pitch(0.4), y_pitch(0.4), x_flip(1), y_flip(1)
{
    fDetectorList.clear();
}

GEMDetectorLayer::GEMDetectorLayer(const int &layer_id) : id(layer_id), nChambersPerLayer(2), readout_type("CARTESIAN"),
    x_offset(0), y_offset(0),
    gem_type("PRADSIMGEM"), nb_apvs_chamber_x_plane(13),
    nb_apvs_chamber_y_plane(24), x_pitch(0.4), y_pitch(0.4), x_flip(1), y_flip(1)
{
